...
namespace QuanLyChungCu.View
{
    public partial class QuanLyThietBi : Form
    {
        ...
        string[] optionFind = { "Mã thiết bị", "Tên thiết bị", "Mã loại thiết bị", "Phòng học" };
        ...
        private void QuanLyThietBi_Load(object sender, EventArgs e)
        {
            ...
            cbbLoaiTimKiem.DataSource = optionFind;
        }
        ...
        {
            string tieuchi = "";
            string option = (string)cbbLoaiTimKiem.SelectedItem;
